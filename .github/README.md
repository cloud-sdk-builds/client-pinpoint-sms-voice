...
[`@aws-sdk/client-pinpoint-sms-voice`](https://www.npmjs.com/package/@aws-sdk/client-pinpoint-sms-voice/v/3.47.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pinpoint-sms-voice@3.47.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Q0V4iBzI1eFw6VclJzm1avneEvvzSvz7if4Xe5cg3CL66zF+ko64usNhhdVNaYgA
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pinpoint-sms-voice": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pinpoint-sms-voice@3.47.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pinpoint-sms-voice@3.47.0/index.min.mjs": "sha384-Q0V4iBzI1eFw6VclJzm1avneEvvzSvz7if4Xe5cg3CL66zF+ko64usNhhdVNaYgA"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pinpoint-sms-voice/blob/refs/tags/3.47.0/LICENSE
```
